...
function httpHandler(store, req, res) {
  ...
  req.on('end', function() {
    ...
    rand52CharId(function(err, id) {
      ...
      if (req.method != 'POST' ||
          (body && contentType != 'application/json' && contentType != 'application/x-amz-json-1.1')) {
        req.removeAllListeners()
        res.statusCode = 404
      ...
      res.contentType = contentType != 'application/x-amz-json-1.1' ? 'application/json' : contentType
